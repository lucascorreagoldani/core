...
public class playerCombatInfo {
    ...
    private int combatEntries; // Nova propriedade: contador de entradas em combate
    private long totalCombatTime; // Nova propriedade: tempo total em combate (milissegundos)
